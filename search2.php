...
$students = mysqli_query($con, "SELECT * FROM archived WHERE Firstname LIKE '%$searched%' OR Middlename LIKE '%$searched%' OR Initial='". $searched ."' OR Lastname LIKE '%$searched%' OR Age='". $searched ."' OR Gender='". $searched ."' OR Grade='". $searched ."' OR Section='". $searched ."' OR SY='". $searched ."' OR LRN='". $searched ."'");
