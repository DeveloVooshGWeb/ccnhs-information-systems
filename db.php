...
if ($confirmres <= 0) {
mysqli_query($con, "INSERT INTO student_records VALUES (0, '". $firstname ."', '". $middlename ."', '". $initial ."', '". $lastname ."', ". $age .", '". $gender ."', ". $grade .", '". $section ."', ". $SY .", ". $LRN .")");
echo "<div id='block'></div><newt>Success!!!</newt>";
$success = 1;
} else {
echo "<div id='block'></div><newt>Sorry!!! There Is An Existing Record!!!</newt>";
$success = 0;
}
}
} else {
...
<div id="space"></div>
<input type="number" name="age" placeholder="Age" required /> <required id="age"></required>
<div id="space"></div>
<input type="text" name="gender" placeholder="Gender/Sex" required /><required id="gender"></required>
<div id="space"></div>
<input type="number" name="grade" placeholder="Grade" required /><required id="grade"></required>
<div id="space"></div>
<input type="text" name="section" placeholder="Section" required /><required id="section"></required>
<div id="space"></div>
<input type="number" name="sy" placeholder="School Year" required /><required id="sy"></required>
<div id="space"></div>
...
<div id="block"></div>
<button id="submit" onclick="location='db2.php?user=' + localStorage.Account">Archive Records</button>
</body>
<script>
